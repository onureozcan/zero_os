...
#define VFS_ERROR_DEVICE_WAS_NULL 1
#define VFS_ERROR_DEVICE_NOT_ENABLED 2
#define VFS_ERROR_NO_SUCH_FILE 3
#define VFS_ERROR_NO_SUCH_VOLUME 4
#define VFS_ERROR_NO_SUCH_FS 5
